...
| LD2451 | 🧪 测试中 | 2D（极坐标） | 3 | 115200 | 多目标追踪、存在检测 | [文档](docs/ld2451/README_CN.md) |
| LD6002 | 🔧 开发中 | 1D（距离） | 1 | 1382400 | 呼吸、心率、存在检测 | [文档](docs/ld6002/README_CN.md) |
| LD2410 | 🔧 开发中 | 1D（距离） | 1 | 256000 | 存在/运动检测、分距离门能量 | — |
| LD2410B | 🧪 测试中 | 1D（距离） | 1 | 256000 | 存在/运动检测 | [文档](docs/ld2410b/README_CN.md) |
| LD2410C | 🧪 测试中 | 1D（距离） | 1 | 256000 | 存在/运动检测 | [文档](docs/ld2410c/README_CN.md) |
