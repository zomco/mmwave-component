# LD2410B ESPHome Component

This component integrates the **LD2410B** human presence radar into ESPHome.

The LD2410B is a 1D presence and motion tracking radar. By applying a 3D coordinate transformation pipeline, it projects its linear detection distance into a standard 3D room coordinate space, making it compatible with other unified radar components.
